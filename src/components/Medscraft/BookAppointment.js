...
// const cities = ['Bangalore', 'Gurugram'];
...
//   return (
//     <Container component="main" maxWidth="sm" style={{padding:'20px 0px 40px 0px'}}>
//       <Paper elevation={3} style={{ padding: '20px', marginTop: '120px', backgroundColor: 'white' }}>
