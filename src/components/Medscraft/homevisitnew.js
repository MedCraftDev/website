...
export default function HomevisitNew() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://medscraft-medscraftserver.fcxl63.easypanel.host/api/homevisits", {
                method: "POST",
                headers: {
                ...
                <div className="row mt-4 mb-4">
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12">
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <h4 className="text-uppercase">Our Community<span className="visithh mt-5"><br />———</span></h4>
                                </div>
                            </div>
                        </div>
                        <div className="container">
                            ...
                            <div className="container mt-5">
                                <div className="row mt-3">
                                    <div className="col-lg-12 mt-4">
                                        <h4 className="text-uppercase">Why MedsCraft<span className="visithh mt-5"><br />———</span></h4>
                                    </div>
                                </div>
                            </div>
                            <div className="container ">
                                    ...
                                    <div class=" col-lg-3 col-md-6 col-sm-6 col-12 ">
                                        <div class="card card-bdr">
                                            <div className="d-flex justify-content-center mt-1">
                                                <img src={Excellence} className='crdicon' alt="ticicon" />
                                            </div>

                                            <div class="card-body">
                                                <h5 class="card-title text-center card-titl">Excellence Assured</h5>
                                                <p class="card-text crd-para">Expert doctors with proven experience, best quality medical supplies</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="card card-bdr">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title text-center card-titl">Equipped & Ready</h5>
                                                <p class="card-text crd-para">Expert doctors with proven experience, best quality medical supplies</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-bdr">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title text-center card-titl">Detailed Consultation</h5>
                                                <p class="card-text crd-para">Expert doctors with proven experience, best quality medical supplies</p>
                                            </div>
                                        </div>
                                    </div><div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                        <div class="card card-bdr">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title text-center card-titl">Follow-up Assistance</h5>
                                                <p class="card-text crd-para">Expert doctors with proven experience, best quality medical supplies</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="container mt-5">
                            <div className="row mt-3">
                                <div className="col-lg-12 mt-4">
                                    <h4 className="text-uppercase">Our Various Services<span className="visithh mt-5"><br />———</span></h4>
                                    <h2 className='mt-3 mb-3 service-title '>Compassionate Care
                        ...
                        <div className="container-fluid p-2 mt-3">
                            <div className="row service-body">
                                <div className="col-lg-7 col-md-7 col-sm-12 col-12">
                                    <div className="mt-4 p-3">
                                        <h2 className="text-light">
                                            Book your first visit for
                                        </h2>
                                        <h2 className="text-light mt-3">
                                            <FontAwesomeIcon className='' icon={faIndianRupeeSign} />849
                                        </h2>
                                        <div className="col-lg-7 col-md-10 col-12 col-sm-12  mt-5">
                                            <a className="insideboxtxt" href="tel:8088435500">
