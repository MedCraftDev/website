...
const ClinicOnBoarding = ({ onClinicAdded }) => {
  ...
  return (
    <div className="clinic-onboarding-container">
      <div className="page-wrapper">
        <div className="content">
          <div className="page-header">
            <div className="row">
              {/* <div className="col-sm-12"> */}
              <h3 className="page-title"> Clinic On Boarding</h3>
              {/* </div> */}
            </div>
          </div>
          <div className="row">
                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12">
                        <div className="form-group local-forms">
                          ...
                          {errors.clinicDescription && (
                            <p className="text-danger">
                              {errors.clinicDescription.message}
                            </p>
                          )}
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-xl-4">
                        <div className="form-group local-forms">
                          ...
                          />
                          {errors.clinicSpecialties && (
                            <p className="text-danger">
                              {errors.clinicSpecialties.message}
                            </p>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-6 col-xl-4">
                        <div className="form-group local-forms">
                          ...
                          />
                          {errors.numberOfNurses && (
                            <p className="text-danger">
                              {errors.numberOfNurses.message}
                            </p>
                          )}
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-xl-4">
                        <div className="form-group local-forms">
                          ...
                          />
                          {errors.numberOfAdministrativeStaff && (
                            <p className="text-danger">
                              {errors.numberOfAdministrativeStaff.message}
                            </p>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12">
                        <div className="form-group local-forms">
                          ...
                          {errors.insuranceAccepted && (
                            <p className="text-danger">
                              {errors.insuranceAccepted.message}
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="col-12 col-md-6 col-xl-4">
                        <div className="form-group local-forms">
                          <label>
                            Affiliations with Hospitals or Medical Networks{" "}
                            <span className="login-danger">*</span>
                          </label>
                          <input
                            className="form-control"
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-6 col-xl-4">
                        <div className="form-group local-forms">
                          ...
                          {errors.parkingAvailability && (
                            <p className="text-danger">
                              {errors.parkingAvailability.message}
                            </p>
                          )}
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-xl-4">
                        <div className="form-group local-forms">
                          ...
                          {errors.wheelchairAccessibility && (
                            <p className="text-danger">
                              {errors.wheelchairAccessibility.message}
                            </p>
                          )}
                        </div>
                      </div>
                      <div className="col-12 col-md-6 col-xl-4">
                        <div className="form-group local-forms">
                          ...
                          {errors.onlineAppointmentBooking && (
                            <p className="text-danger">
                              {errors.onlineAppointmentBooking.message}
                            </p>
                          )}
                        </div>
                      </div>
