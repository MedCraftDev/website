...
// import { blog, dashboard, doctor, doctorschedule, logout, menuicon04, menuicon06, menuicon08, menuicon09, menuicon10, menuicon11, menuicon12, menuicon14, menuicon15, menuicon16, patients, sidemenu, clinic } from './imagepath';
...
//                     <span className="menu-side">
//                       <img src={clinic} alt="" height={20} width={20} />
//                     </span>{" "}
//                     <span>Clinics</span> <span className="menu-arrow" />
//                   </Link>
//                   <ul style={{ display: "none" }} className="menu-items3">
//                   <li>
//                       <Link className={props?.activeClassName === 'add-clinic' ? 'active' : ''} to="/addclinics">Add Clinics</Link>
//                     </li>
//                     <li>
//                       <Link className={props?.activeClassName === 'clinic-list' ? 'active' : ''} to="/clinicslist">Clinics List</Link>
//                     </li>
//                     {/* <li>
//                       <Link className={props?.activeClassName === 'edit-patient' ? 'active' : ''} to="/editpatients">Edit Patients</Link>
//                     </li>
              ...
              <ul>
                ...
                <li className="submenu" >
                  ...
                  <ul style={{ display: sidebar === 'Dashboard' ? 'block' : "none" }} className='menu-items'>
                    ...
                    <li>
                      <Link className={props?.activeClassName === 'clinic-dashboard' ? 'active' : ''} to="/clinic-dashboard">Clinic Dashboard</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'patient-dashboard' ? 'active' : ''} to="/patient-dashboard">Patient Dashboard</Link>
                    </li>
                ...
                <li className="submenu">
                  <Link to="#" id="menu-item3" onClick={(e) => {
                    // setSidebar('Doctors')
                    ...
                    <span> Clinic </span> <span className="menu-arrow" /> 
                  </Link>
                  <ul style={{ display: sidebar === 'Doctors' ? 'block' : 'none' }} className="menu-items3">
                    <li>
                      <Link className={props?.activeClassName === 'clinic-list' ? 'active' : ''} to="/cliniclist">Clinic List</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'add-clinic' ? 'active' : ''} to="/add-clinic">Add Clinic</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'edit-clinic' ? 'active' : ''} to="/editclinic">Edit Clinic</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'clinic-profile' ? 'active' : ''} to="/clinicprofile">Clinic Profile</Link>
                    </li>
                  </ul>
                </li>
                <li className="submenu">
