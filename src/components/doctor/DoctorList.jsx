...
// import { GET_DOCTORS_URL } from '../../Util/const';
// import { getRequest } from '../../Util/fetchDoctorUtil';
...
//     try {
//       const data = await getRequest(GET_DOCTORS_URL);
...
//       title: 'Name',
//       dataIndex: 'name',
//       render: (text, record) => <Link to="#">{record.firstName} {record.lastName}</Link>,
...
//       title: 'Time',
//       dataIndex: 'timings',
//       sorter: (a, b) => a.timings.length - b.timings.length,
//     },
//     {
//       title: 'Mobile',
//       dataIndex: 'mobile',
//       sorter: (a, b) => a.mobile.length - b.mobile.length,
//       render: (text, record) => <Link to="#">{record.mobile}</Link>,
//     },
//     {
//       title: 'Email',
//       dataIndex: 'email',
...
//     {
//       title: 'Fee',
//       dataIndex: 'feePerVisit',
//       sorter: (a, b) => a.feePerVisit.length - b.feePerVisit.length,
//     },
//   ];
...
//                               </Link>
//                               <Link to="#" className="btn btn-primary doctor-refresh ms-2" onClick={fetchDoctors}>
